...
export default function OpenStatus() {
  ...
  useEffect(() => {
    // Status depends on the viewer's clock, so it's only computed after
    // mount (computing it during render would mismatch the server-rendered
    // placeholder and cause a hydration error).
