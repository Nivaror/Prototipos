...
const baseMetadata: Metadata = {
  title: "MED's | Certificados médicos deportivos y escolares",
  description: "Orientación simple para solicitar tu certificado médico deportivo o escolar en Rosario.",
};
