/**
 * Confirmed schedule from the Google Maps listing: daily except Monday,
 * lunch 11:30-14:30 and dinner 20:00-23:30. No shift crosses midnight, so
 * this is simpler than the sector's night-heavy siblings.
 */
...
export const SCHEDULE: Record<number, Shift[]> = {
  0: [{ from: h(11, 30), to: h(14, 30) }, { from: h(20), to: h(23, 30) }],
  1: [],
  2: [{ from: h(11, 30), to: h(14, 30) }, { from: h(20), to: h(23, 30) }],
  3: [{ from: h(11, 30), to: h(14, 30) }, { from: h(20), to: h(23, 30) }],
  4: [{ from: h(11, 30), to: h(14, 30) }, { from: h(20), to: h(23, 30) }],
  5: [{ from: h(11, 30), to: h(14, 30) }, { from: h(20), to: h(23, 30) }],
  6: [{ from: h(11, 30), to: h(14, 30) }, { from: h(20), to: h(23, 30) }],
};
...
export function isOpenAt(weekday: number, minutes: number) {
  return (SCHEDULE[weekday] ?? []).some((s) => minutes >= s.from && minutes < s.to);
}
...
export const MAPS_URL =
  "https://www.google.com/maps/search/?api=1&query=Hosteria+Yacyreta+Itucatering&query_place_id=ChIJo34AWCVHV5QR6YSBRJEa6fo";
