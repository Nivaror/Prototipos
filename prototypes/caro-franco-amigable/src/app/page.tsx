...
export default function Home() {
  return (
    <>
      ...
      <section id="reservar" className={`seccion ${s.reservaSec}`}>
        <div className="wrap">
          <div className={s.reservaTit}>
            <h1 className="h1">Sacá tu turno</h1>
            <p className="lead" style={{ marginTop: '.9rem' }}>
              Elegí el servicio, con quién te querés atender y cuándo. Solo se muestran los horarios que están realmente libres.
            </p>
          </div>
          <Reserva />
        </div>
      ...
      <section className={s.heroFoto} aria-label="Fotos del salón">
        <figure>
