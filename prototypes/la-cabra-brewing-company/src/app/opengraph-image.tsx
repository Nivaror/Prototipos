...
export const alt = "La Cabra Brewing Company";
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        <div style={{ display: "flex", width: 96, height: 8, background: "#3d5fff" }} />
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ marginTop: 24, fontSize: 34, color: "#3d5fff" }}>Cervecería artesanal</div>
        </div>
        <div style={{ display: "flex", fontSize: 24, color: "#10192c", opacity: 0.55 }}>
